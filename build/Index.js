...
/******/ 	__webpack_require__.p = "/Users/Emmanuel/Work/Reason/fifteen/build/";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Game$Fifteen = __webpack_require__(1);

	Game$Fifteen.create(/* () */0);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Board$Fifteen = __webpack_require__(2);
	var Canvas$Fifteen = __webpack_require__(37);

	function show(id) {
	  var __x = document.getElementById(id).style;
	  __x.display = "block";
	  return /* () */0;
	}

	function create() {
	  var canvas = Canvas$Fifteen.create("game", "image", 600);
	  var board = [Board$Fifteen.initial(/* () */0)];
	  Board$Fifteen.draw(board[0], canvas);
	  return Canvas$Fifteen.onClick(canvas, (function (evt) {
	                board[0] = Board$Fifteen.click(/* tuple */[
	                      evt.offsetX,
	                      evt.offsetY
	                    ], board[0]);
	                var solved = Board$Fifteen.solved(board[0]);
	                Board$Fifteen.draw(board[0], canvas);
	                if (solved !== 0) {
	                  return show("msg");
	                } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Belt_List = __webpack_require__(33);
	var Belt_Array = __webpack_require__(34);
	...
	function toIdx(param) {
	  return param[0] + Caml_int32.imul(3, param[1]) | 0;
	}
	...
	function toImgC(param) {
	  return /* tuple */[
	          Caml_int32.imul(param[0], width),
	          Caml_int32.imul(param[1], width)
	        ];
	}

	function toTileC(param) {
	  return /* tuple */[
	          Caml_int32.div(param[0], width),
	          Caml_int32.div(param[1], width)
	        ];
	}

	function replaceWithHole(i, b) {
	  var match = Caml_array.caml_array_get(b, i);
	  if (match) {
	    Caml_array.caml_array_set(b, i, /* Hole */0);
	    return b;
	  } else {
	    throw [
	...
	function draw(b, cvs) {
	  return Belt_Array.forEachWithIndex(b, (function (i, t) {
	                var param = toCoords(i);
	                var tile = t;
	                var cvs$1 = cvs;
	                var width$1 = width;
	                var j$prime = param[1];
	                ...
	                if (tile) {
	                  var match = tile[0];
	                  return Canvas$Fifteen.drawImage(cvs$1, Caml_int32.imul(match[0], width$1), Caml_int32.imul(match[1], width$1), Caml_int32.imul(i$prime, width$1), Caml_int32.imul(j$prime, width$1), width$1);
	                } else {
	                  return Canvas$Fifteen.fillRect(cvs$1, Caml_int32.imul(i$prime, width$1), Caml_int32.imul(j$prime, width$1), width$1, "#000000");
	                }
	              }));
	}
	...
	function swapable(b) {
	  var match = toCoords(holeIdx(b));
	  var hy = match[1];
	  var hx = match[0];
	  var neighbours_000 = /* tuple */[
	    hx - 1 | 0,
	    hy
	  ];
	  var neighbours_001 = /* :: */[
	  ...
	  var l = Belt_List.keep(neighbours, inBounds);
	  return Belt_List.map(l, toIdx);
	}

	function swap(i1, i2, b) {
	  var t1 = Caml_array.caml_array_get(b, i1);
	  Caml_array.caml_array_set(b, i1, Caml_array.caml_array_get(b, i2));
	  Caml_array.caml_array_set(b, i2, t1);
	  return b;
	}

	function click(param, b) {
	  var i$prime = toIdx(toTileC(/* tuple */[
	            param[0],
	            param[1]
	          ]));
	  if (Belt_List.some(swapable(b), (function (i) {
	            return +(i === i$prime);
	          }))) {
	    return swap(i$prime, holeIdx(b), b);
	  } else {
	    return b;
	  }
	}
	...
	function initial() {
	  var n = 15;
	  var b = replaceWithHole(Random.$$int(16), Belt_Array.makeBy(size, (function (i) {
	              return tile(toCoords(i));
	            })));
	  Random.self_init(/* () */0);
	  var rounds = Random.$$int(n) + n | 0;
	  var _n = rounds;
	  var _lastIdx = -1;
	  var _b = b;
	  while(true) {
	    ...
	    var n$1 = _n;
	    if (n$1 > 0) {
	      var b$2 = Belt_List.shuffle(swapable(b$1));
	      var nextIdx = Belt_List.headExn(Belt_List.keep(b$2, (function(lastIdx){
	              return function (idx) {
	                return +(idx !== lastIdx);
	              }
	              }(lastIdx))));
	      var holeIdx$1 = holeIdx(b$1);
	      var b$prime = swap(holeIdx$1, nextIdx, b$1);
	      _b = b$prime;
	      _lastIdx = nextIdx;
	      _n = n$1 - 1 | 0;
	      continue ;
	...
	function solved(b) {
	  var b$1 = Belt_Array.mapWithIndex(b, (function (i, t) {
	          if (t) {
	            return +(i === toIdx(t[0]));
	          } else {
	            return /* true */1;
	  ...
	  return Belt_Array.every(b$1, id);
	}
	...
	exports.holeIdx = holeIdx;
	exports.swap = swap;
	exports.draw = draw;
	exports.initial = initial;
	exports.toIdx = toIdx;
	exports.toCoords = toCoords;
	exports.toImgC = toImgC;
	exports.toTileC = toTileC;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Int32 = __webpack_require__(10);
	var Int64 = __webpack_require__(16);
	var Digest = __webpack_require__(17);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Caml_primitive = __webpack_require__(15);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Char = __webpack_require__(18);
	var $$String = __webpack_require__(20);
	var Caml_md5 = __webpack_require__(31);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Curry = __webpack_require__(5);
	var Caml_obj = __webpack_require__(22);
	var Pervasives = __webpack_require__(24);
	var Caml_builtin_exceptions = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Block = __webpack_require__(23);
	var Caml_primitive = __webpack_require__(15);
	var Caml_builtin_exceptions = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Curry = __webpack_require__(5);
	var Caml_io = __webpack_require__(25);
	var Caml_sys = __webpack_require__(27);
	var Caml_format = __webpack_require__(11);
	var Caml_string = __webpack_require__(19);
	var Caml_exceptions = __webpack_require__(9);
	var Caml_missing_polyfill = __webpack_require__(28);
	var Caml_builtin_exceptions = __webpack_require__(7);
	var CamlinternalFormatBasics = __webpack_require__(29);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Curry = __webpack_require__(5);
	var Js_math = __webpack_require__(35);
	var Caml_primitive = __webpack_require__(15);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Js_int = __webpack_require__(36);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function create(containerId, imageId, width) {
	...
	function clear(param) {
	  if (param) {
	    var cvs = param[0];
	    var width = cvs.innerWidth;
	    var ctx = cvs.getContext("2d");
	    ctx.clearRect(0, 0, width, width);
	    return /* () */0;
	  } else {
	    return Pervasives.failwith("Empty Canvas");
	  }
	}

	function fillRect(cvs, x, y, width, color) {
	  if (cvs) {
	...
	function drawImage(cvs, x, y, x$prime, y$prime, width) {
	  if (cvs) {
	    var ctx = cvs[0].getContext("2d");
	    ctx.drawImage(cvs[1], x, y, width, width, x$prime, y$prime, width, width);
	    return /* () */0;
	  } else {
	    return Pervasives.failwith("Empty Canvas");
	  }
	...
	function onClick(cvs, handle) {
	  if (cvs) {
	    cvs[0].addEventListener("click", handle);
	    return /* () */0;
	  } else {
	    return Pervasives.failwith("Empty Canvas");
	  }
