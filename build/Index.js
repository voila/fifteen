...
/***/ function(module, exports, __webpack_require__) {
	...
	function create() {
	  ...
	  var b = [Board$Fifteen.initial(/* () */0)];
	  Board$Fifteen.draw(b[0], canvas);
	  return Canvas$Fifteen.onClick(canvas, (function (evt) {
	                b[0] = Board$Fifteen.click(/* tuple */[
	                      evt.offsetX,
	                      evt.offsetY
	                    ], b[0]);
	                Board$Fifteen.draw(b[0], canvas);
	                var match = Board$Fifteen.solved(b[0]);
	                if (match !== 0) {
	                  var id = "msg";
...
/***/ function(module, exports, __webpack_require__) {
	...
	function draw(b, cvs) {
	  return Belt_Array.forEachWithIndex(b, (function (i, t) {
	                ...
	                if (tile) {
	                  var match = tile[0];
	                  return Canvas$Fifteen.drawImage(canvas, Caml_int32.imul(match[0], width$1), Caml_int32.imul(match[1], width$1), Caml_int32.imul(i$prime, width$1), Caml_int32.imul(j$prime, width$1), width$1);
	                } else {
	                  return Canvas$Fifteen.fillRect(canvas, Caml_int32.imul(i$prime, width$1), Caml_int32.imul(j$prime, width$1), width$1, "#000000");
	                }
	              }));
	}
...
/***/ function(module, exports) {
	...
	function fillRect(param, x, y, width, color) {
	  var ctx = param[1];
	  ctx.fillStyle = color;
	...
	function drawImage(param, sx, sy, dx, dy, width) {
	  param[1].drawImage(param[2], sx, sy, width, width, dx, dy, width, width);
	  return /* () */0;
	}

	function onClick(param, handle) {
	  param[0].addEventListener("click", handle);
	  return /* () */0;
	}
